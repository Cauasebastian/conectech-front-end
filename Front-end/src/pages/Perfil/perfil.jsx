        ...
        <div className="min-w-screen min-h-screen bg-[#fbfbfb] flex flex-col">
            ...
            <div className="mp:ml-24 mt-24  flex flex-col items-center">
                <div className="w-full flex justify-between items-center">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
                        className="w-7 h-7 hidden xl:block xl:mr-14 3xl:mr-44 3xl:h-9 3xl:w-9 text-[#4A91A5]">
                ...
                <div className="w-full flex flex-col items-center gap-3 mt-8 lg:mt-12 xl:mt-0">
                    <img src="images/user.png" className="w-16 h-16 md:w-20 md:h-20 lg:w-28 lg:h-28 3xl:h-36 3xl:w-36" alt="" />
                    <p className="font-poppins text-lg">{user.name}</p>
                    <div className="flex justify-center">
                        <div className="flex flex-col items-center justify-center">
                            <p className="font-poppins text-sm 2xl:text-base 3xl:text-lg">350</p>
                        ...
                        <div className="flex flex-col items-center justify-center">
                            <p className="font-poppins text-sm 2xl:text-base 3xl:text-lg">346</p>
                ...
                <div className="mt-5 2xl:mt-8 w-full flex items-center justify-center gap-2">
                    <button className="flex justify-center gap-2 bg-[#074261] py-2 px-6 md:px-12 2xl:px-14 3xl:py-3 3xl:px-20  rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
                    ...
                    <button className="flex justify-center gap-2 bg-[#fbfbfb] py-2 px-3 md:px-8 2xl:px-10 3xl:py-3 3xl:px-14 rounded-md border border-[#074261]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
                            className="w-5 h-5 text-[#074261] 3xl:w-6 3xl:h-6">
                ...
                {activeIndex === 0 && (
                    <p className="text-[#3C3E56] text-sm 2xl:text-lg 3xl:text-xl mb-5 xl:mb-12 w-full mm:w-[85%] sm:w-[80%] lg:w-[60%] xl:w-[45%] 2xl:w-[40%] 3xl:w-[30%]">
                      Tenho interesse em SQL e sou apaixonada por programar. Tenho total certeza que posso inspirar as pessoas ao meu redor e ajudá-las a entenderem mais o que é esse mundo da tecnologia.
                    </p>
                )}
                <div className="flex flex-col gap-2 3xl:gap-5 mb-5 items-start w-full mm:w-[85%] sm:w-[80%] lg:w-[60%] xl:w-[45%] 2xl:w-[40%] 3xl:w-[30%]">
                    ...
                    <div className="w-full flex flex-wrap gap-2 2xl:gap-5">
                        {meusInteresses.map((item, index) => (
                             <span key={index} id="item-tag" className='font-poppins px-2 py-1 rounded-3xl text-[0.6rem] mg:text-xs 2xl:text-sm 3xl:text-lg 3xl:py-2 3xl:px-4  text-[#FFFFFF] bg-[#4A91A5]' >{item}</span>
                        ))}
                        {/* {meusInteresses.map((item, index) => 
                            <span key={index} id="item-tag" className='font-poppins px-2 py-1 rounded-xl text-[0.6rem]  text-[#FFFFFF] bg-[#4A91A5]' >{item.nome}</span>
                        )} */}
