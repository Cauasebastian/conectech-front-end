...
const Evento = ({ imagem, titulo, data, local, totalParticipantes, organizador, descricaoEvento, fotoOrganizador}) => {
    ...
    return(
        <div className='mp:mt-1 grid w-full grid-cols-3 gap-4 sm:gap-0  mp:p-3 items-center shadow-lg rounded-lg mp:mx-3   ' onClick={goToTelaEvento}>
            <img className='col-span-1 h-[90%] sm:h-full object-cover mp:w-20 md:w-32 rounded-lg' src={imagem}/>
            <div className='col-span-2 mp:-ml-2 sm:-ml-9 md:ml-3 flex flex-col  justify-center'>
                <div>
