...
const ParteSecundaria = () => {
    return(
        <div id="como-funciona" className=" mt-32 flex flex-col items-center justify-center  ">
            ...
            <div className='absolute flex gap-3 w-full justify-center  h-1/4 mm:h-1/3 mm:mt-44 mg:mt-36 sm:h-2/5  mt-28 lg:mb-9 lg:gap-8  lg:mt-72 xl:h-3/5 2xl:mt-96 3xl:h-4/5 3xl:mt-96'> 
